...
namespace Opencart\Admin\Model\Extension\PaytrHavaleEft\Payment;
...
class PaytrEftTransfer extends Model
{
    ...
    {
        $this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "paytr_eft_transaction` (
    ...
    {
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "paytr_eft_transaction`;");
    }
}
